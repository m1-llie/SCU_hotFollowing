...
const Cfg = {
    ...
    getWeatherPeriod: settings.getWeatherPeriod || 100, //天气预报更新周期（分）
    chartRefreshPeriod: settings.chartRefreshPeriod || 20, // 图表刷新周期（秒）
